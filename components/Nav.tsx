  ...
  return (
        <div className='w-auto h-[70px] my-[20px] relative py-[3px} flex flex-row justify-between items-center mx-[12px] bg-inherit'>
            ...
            <div className='flex-row gap-8 font-semibold flex text-gray-700'>
                ...
                <a href='' className="group relative">Compare<span className="pointer-events-none absolute left-0 -bottom-1 h-0.5 w-full origin-center scale-x-0 transform bg-gray-700 transition-transform duration-300 group-hover:scale-x-100"></span></a>
                <a href='' className="group relative">Pricing<span className="pointer-events-none absolute left-0 -bottom-1 h-0.5 w-full origin-center scale-x-0 transform bg-gray-700 transition-transform duration-300 group-hover:scale-x-100"></span></a>
                <a href='' className="group relative">Resources<span className="pointer-events-none absolute left-0 -bottom-1 h-0.5 w-full origin-center scale-x-0 transform bg-gray-700 transition-transform duration-300 group-hover:scale-x-100"></span></a>
