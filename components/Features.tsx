...
const Features = () => {
  return (
    <div className='mt-[700px] mx-[150px] gap-12 flex flex-col mb-10 xl:items-center' id="features">
        <div className='text-start flex flex-col gap-6 left-1/2 xl:w-[1200px]'>
