...
const Hero = () => {
  return (
    ...
    <div className="relative isolate h-[750px] bg-gray-50 overflow-hidden w-[1500px] flex flex-col items-center">
      ...
      {/* Foreground Content */}
      <div className='mt-[75px] flex flex-col items-center justify-center relative z-20 bg-gradient-to-b from-gray-50 via-gray-50/90 to-transparent motion-delay-500 motion-blur-in-xl motion-duration-1200'>
        ...
        <div className="mt-[30px]">
           ...
           <div className='flex flex-row justify-center items-center gap-4 mt-[50px] motion-preset-blur-down motion-duration-3000'>
            <a href='#pricing'>
