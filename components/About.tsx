        ...
        {/* Foreground Content */}
            <div className='flex flex-col relative z-20 bg-transparent gap-[65px]'>
                <div className="flex flex-col justify-center gap-[65px]">
                    ...
                    <h1 className="text-5xl font-semibold text-gray-700 flex flex-col">
                        <span className='flex flex-row gap-3 items-center'>Our platform harnesses the power of AI<img src="/spike.webp" className='w-[80px] h-[80px]'/></span>
                        <span className='text-gray-400 flex flex-row gap-2 items-center'>to streamline processes <img src="/prism.webp" className='w-[80px] h-[80px]'/>and optimize</span>
                        <span className='flex flex-row gap-2 text-gray-400 items-center'>outcomes.<img src="/swirl.webp" className='w-[80px] h-[80px]'/></span>
                    </h1>
                </div>
                <div>
                <a href='#pricing'>    
